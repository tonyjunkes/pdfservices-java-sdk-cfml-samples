...
component displayname="RotatePDFPages" {
    public RotatePDFPages function init() {
        ...
        variables.java_RotatePagesOperation = createObject("java", "com.adobe.pdfservices.operation.pdfops.RotatePagesOperation");
        variables.java_PageRanges = createObject("java", "com.adobe.pdfservices.operation.pdfops.options.PageRanges");
        variables.java_Angle = createObject("java", "com.adobe.pdfservices.operation.pdfops.options.rotatepages.Angle");
