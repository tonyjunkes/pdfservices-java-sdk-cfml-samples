 ...
 */
component displayname="PDF Properties As File" {
    public PDFPropertiesAsFile function init() {
    ...
    public void function run() {
        try {
            ...
            var result = pdfPropertiesOperation.executeAndReturnFileRef(executionContext);

            // Save the result to the specified location.
            result.saveAs(application.outputPath & "/pdfPropertiesOutput.json");
        }
        catch(any e) {
