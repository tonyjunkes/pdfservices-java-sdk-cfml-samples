 ...
 */
component displayname="Create PDF From PPTX" {
    public CreatePDFFromPPTX function init() {
    ...
    public void function run() {
        try {
            ...
            var source = variables.java_FileRef.createFromLocalFile(
                application.resourcesPath & "/createPDFInput.pptx"
            );
            ...
            result.saveAs(application.outputPath & "/createPDFFromPPTX.pdf");
        } catch(any e) {
