 ...
 */
component displayname="Create PDF From HTML With Inline CSS" {
    public CreatePDFFromHTMLWithInlineCSS function init() {
    ...
    public void function run() {
        try {
            ...
            var source = variables.java_FileRef.createFromLocalFile(
                application.resourcesPath & "/createPDFFromHTMLWithInlineCSSInput.html"
            );
            ...
            result.saveAs(application.outputPath & "/createPDFFromHTMLWithInlineCSSOutput.pdf");
        }
        catch(any e) {
