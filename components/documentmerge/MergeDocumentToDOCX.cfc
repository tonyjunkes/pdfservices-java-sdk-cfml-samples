...
component displayname="Merge Document To DOCX" {
    ...
    public void function run() {
        try {
            ...
            var documentMergeOptions = variables.java_DocumentMergeOptions.init(jsonDataForMerge, variables.java_OutputFormat.DOCX);
            ...
            var documentTemplate = variables.java_FileRef.createFromLocalFile(
                application.resourcesPath & "/documentMergeTemplate.docx"
            );
            ...
            result.saveAs(application.outputPath & "/documentMergeOutput.docx");
        }
        catch(any e) {
