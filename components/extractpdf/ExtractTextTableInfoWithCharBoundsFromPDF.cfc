 ...
 */
component displayname="Extract Text Table Info With Char Bounds From PDF" {
    public ExtractTextTableInfoWithCharBoundsFromPDF function init() {
    ...
    public void function run() {
        try {
            ...
            result.saveAs(application.outputPath & "/ExtractTextTableInfoWithCharBoundsFromPDF.zip");
        }
        catch(any e) {
