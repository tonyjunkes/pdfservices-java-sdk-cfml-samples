 ...
 */
component displayname="Extract Text Info From PDF" {
    public ExtractTextInfoFromPDF function init() {
    ...
    public void function run() {
        try {
            ...
            var extractPDFOptions = variables.java_ExtractPDFOptions
                ...
                .addElementsToExtract(variables.java_Arrays.asList([variables.java_ExtractElementType.TEXT]))
                .build();
            ...
            result.saveAs(application.outputPath & "/ExtractTextInfoFromPDF.zip");
        }
        catch(any e) {
