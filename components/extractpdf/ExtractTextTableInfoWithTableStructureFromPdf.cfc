 ...
 */
component displayname="Extract Text Table Info With Table Structure From Pdf" {
    public ExtractTextTableInfoWithTableStructureFromPdf function init() {
        ...
        variables.java_TableStructureType = createObject("java", "com.adobe.pdfservices.operation.pdfops.options.extractpdf.TableStructureType");
    ...
    public void function run() {
        try {
            ...
            var extractPDFOptions = variables.java_ExtractPDFOptions
                ...
                .addTableStructureFormat(variables.java_TableStructureType.CSV)
                .build();
            ...
            result.saveAs(application.outputPath & "/ExtractTextTableInfoWithTableStructureFromPdf.zip");
        }
        catch(any e) {
