 ...
 */
component displayname="Extract Text Table Info From PDF" {
    public ExtractTextTableInfoFromPDF function init() {
    ...
    public void function run() {
        try {
            ...
            result.saveAs(application.outputPath & "/ExtractTextTableInfoFromPDF.zip");
        }
        catch(any e) {
